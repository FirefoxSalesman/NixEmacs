...
in
{
  options.programs.emacs.init.ide.lsp-bridge.enable = lib.mkEnableOption "Enable lsp-bridge's preset configuration. (A total of 2 changed variables) & enables it for language support";
