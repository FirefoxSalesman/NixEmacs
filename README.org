...
+ b: consult-bookmark (if simple-completion-extras is enabled)
+ i: consult/counsel-imenu (depending on if you enabled ivy or simple-completion-extras)
+ I: consult-imenu-multi (if you enabled simple-completion-extras)
