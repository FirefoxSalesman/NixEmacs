...
**** Lsp Bridge
***** =programs.emacs.init.ide.lsp.enable= 
A boolean that will enable lsp-bridge-mode for most languages in the language support presets.
...
For eglot & emacs-lisp mode, this is done with [[https://github.com/casouri/eldoc-box][eldoc-box]]. For lsp-mode, this is done with lsp-ui
