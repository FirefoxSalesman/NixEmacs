...
****** =programs.emacs.init.keybinds.evil.up=
Defaults to ="k"=.

****** =programs.emacs.init.keybinds.evil.down=
Defaults to ="j"=.

****** =programs.emacs.init.keybinds.evil.forward=
Defaults to ="l"=.

****** =programs.emacs.init.keybinds.evil.backward=
Defaults to ="h"=.
